...
function debug_kintone() {
  ...
  // const records = Kintone.getRecords({}, "居室利用変更履歴管理", /* offset= */0);
  const records = Kintone.getCustomerMngRecordsByFacilityName("笹貫", true/*isAllFacility*/);
  // const records = Kintone.getCustomerMngRecordsByFacilityName("笹貫", true/*isAllFacility*/);
